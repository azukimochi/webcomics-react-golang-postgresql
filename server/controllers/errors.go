...
// ServeErrors is a function that handles serving up the json response for the errors
func ServeErrors(code string, description string, w http.ResponseWriter, r *http.Request) {
